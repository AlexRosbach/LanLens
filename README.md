...
- Manage SNMP targets and switch topology, including editable target name, host, profile, enabled state, optional background poll interval, detailed poll diagnostics, non-switch SNMP identity scans, IP-scan device classification, and device-detail linkage by assignment or IP match
