...
def _build_switch_port_visualization(db: Session, switch: SnmpSwitch) -> dict:
    ...
    for iface in visible_interfaces:
        ...
        ports.append({
            ...
            "in_packets_per_second": iface.in_packets_per_second,
            "out_packets_per_second": iface.out_packets_per_second,
            "errors_per_minute": iface.errors_per_minute,
            "discards_per_minute": iface.discards_per_minute,
            "layer1_errors_per_minute": iface.layer1_errors_per_minute,
            "is_active": is_active,
            "endpoints": endpoints,
