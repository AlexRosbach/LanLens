...
def _device_to_response(
    ...
    return DeviceResponse(
        ...
        idoit_last_validation_at=device.idoit_sync.last_sync_at if device.idoit_sync and device.idoit_sync.status in ("validated_pending_sync", "mapping_error") else None,
