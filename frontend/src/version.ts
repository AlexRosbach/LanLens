...
export const BUILD_CODE = import.meta.env.VITE_LANLENS_BUILD_CODE || '1.5.4-20260530.5'
...
export const BUILD_CREATED = import.meta.env.VITE_LANLENS_BUILD_CREATED || '2026-05-30T21:03:00Z'
