...
export function DocumentationExportCard() {
  const { t } = useI18n()
  return (
    <Card>
      <h2 className="font-semibold text-text-base mb-3">{t('documentation_export')}</h2>
      <p className="text-sm text-text-subtle mb-3">{t('documentation_export_description')}</p>
...
export function SelectiveBackupCard() {
  const { t } = useI18n()
  return (
    <Card>
...
export function IgnoreRulesCard() {
  const { t } = useI18n()
  ...
  async function load() {
    setRules(await inventoryApi.ignoreRules())
  }
  ...
  return (
    <Card>
      <h2 className="font-semibold text-text-base mb-1">{t('ignore_rules')}</h2>
      <p className="text-sm text-text-subtle mb-4">{t('ignore_rules_description')}</p>
...
export function DeviceMergeCard() {
  const { t } = useI18n()
  ...
  async function load() {
    const deviceRows = await devicesApi.list()
  ...
  return (
    <Card>
      <h2 className="font-semibold text-text-base mb-1">{t('device_merge')}</h2>
      <p className="text-sm text-text-subtle mb-3">{t('device_merge_description')}</p>
      <div className="rounded-lg border border-warning/30 bg-warning/10 p-3 text-sm text-text-muted mb-4">
        <p className="font-medium text-text-base mb-1">{t('device_merge_how_it_works_title')}</p>
        <ul className="list-disc pl-5 space-y-1">
          <li>{t('device_merge_how_it_works_1')}</li>
          <li>{t('device_merge_how_it_works_2')}</li>
          <li>{t('device_merge_how_it_works_3')}</li>
        </ul>
      </div>
      {loading ? <Spinner /> : (
        <>
